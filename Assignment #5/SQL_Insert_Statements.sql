-- NOTE: Prior assignment had some errors in the table STRUCTURE
-- If importing this data, use the updated "SQL_Create_Table_Statments.sql" file prior to this file (old schema needs to be dropped first)
